    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div>
          ...
          <div className="relative flex h-10 w-full  justify-center items-center">
            <input
              type="email"
              ...
              className="!absolute right-1 top-1 
               ...
               font-sans text-xs font-bold uppercase
                ...
                transition-all hover:shadow-lg hover:shadow-pink-500/40
                  ...
                  peer-placeholder-shown:bg-blue-gray-500 peer-placeholder-shown:opacity-50 peer-placeholder-shown:shadow-none"
              type="button"
